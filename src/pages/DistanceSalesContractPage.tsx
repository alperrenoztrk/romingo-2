      ...
      <div className="mx-auto max-w-4xl rounded-3xl border border-slate-200 bg-white p-8 shadow-sm sm:p-12">
        ...
        <section className="mb-8">
          ...
          <p className="text-base leading-7 text-slate-700 sm:text-lg">
            ...
            elektronik ortamda siparişini yaptığı aşağıda nitelikleri ve satış fiyatı belirtilen ürünün/hizmetin satışı
            ve teslimi ile ilgili olarak 6502 sayılı Tüketicinin Korunması Hakkındaki Kanun ve Mesafeli Sözleşmeler
        ...
        <section className="mb-8">
          ...
          <p className="text-base leading-7 text-slate-700 sm:text-lg">
            ALICI, sözleşme konusu ürünün/hizmetin kendisine veya gösterdiği adresteki kişi/kuruluşa tesliminden itibaren
            14 (ondört) gün içinde hiçbir gerekçe göstermeksizin cayma hakkına sahiptir. Ancak, Mesafeli Sözleşmeler
            Yönetmeliği&apos;nin &quot;Cayma Hakkının İstisnaları&quot; başlıklı maddesi uyarınca, elektronik ortamda anında
            ifa edilen hizmetler (sınav giriş ücreti) veya tüketiciye anında teslim edilen gayrimaddi mallara ilişkin
            sözleşmelerde cayma hakkı kullanılamaz. Sitemizde satılan sınava giriş hizmetleri bu kapsama girdiğinden
            cayma hakkı kullanılamaz ve iade yapılamaz.
          </p>
        </section>
