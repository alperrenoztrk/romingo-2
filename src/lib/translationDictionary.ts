...
const supplementalWordPairs: Array<{ tr: string; ro: string }> = [
  ...
  { tr: "Gitmek", ro: "A merge" },
  { tr: "Gidiyorum", ro: "Merg" },
  { tr: "Gidiyorsun", ro: "Mergi" },
  { tr: "Gidiyor", ro: "Merge" },
  { tr: "Gidiyoruz", ro: "Mergem" },
  { tr: "Gidiyorsunuz", ro: "Mergeți" },
  { tr: "Gidiyorlar", ro: "Merg" },
  { tr: "Yemek", ro: "A mânca" },
  { tr: "Yiyorum", ro: "Mănânc" },
  { tr: "Yiyorsun", ro: "Mănânci" },
  { tr: "Yiyor", ro: "Mănâncă" },
  { tr: "Yiyoruz", ro: "Mâncăm" },
  { tr: "Yiyorsunuz", ro: "Mâncați" },
  { tr: "Yiyorlar", ro: "Mănâncă" },
  { tr: "İçmek", ro: "A bea" },
  { tr: "İçiyorum", ro: "Beau" },
  { tr: "İçiyorsun", ro: "Bei" },
  { tr: "İçiyor", ro: "Bea" },
  { tr: "İçiyoruz", ro: "Bem" },
  { tr: "İçiyorsunuz", ro: "Beți" },
  { tr: "İçiyorlar", ro: "Beau" },
  { tr: "Görmek", ro: "A vedea" },
  { tr: "Görüyorum", ro: "Văd" },
  { tr: "Görüyorsun", ro: "Vezi" },
  { tr: "Görüyor", ro: "Vede" },
  { tr: "Görüyoruz", ro: "Vedem" },
  { tr: "Görüyorsunuz", ro: "Vedeți" },
  { tr: "Görüyorlar", ro: "Văd" },
  { tr: "Yapmak", ro: "A face" },
  { tr: "Yapıyorum", ro: "Fac" },
  { tr: "Yapıyorsun", ro: "Faci" },
  { tr: "Yapıyor", ro: "Face" },
  { tr: "Yapıyoruz", ro: "Facem" },
  { tr: "Yapıyorsunuz", ro: "Faceți" },
  { tr: "Yapıyorlar", ro: "Fac" },
  { tr: "Gelmek", ro: "A veni" },
  { tr: "Geliyorum", ro: "Vin" },
  { tr: "Geliyorsun", ro: "Vii" },
  { tr: "Geliyor", ro: "Vine" },
  { tr: "Geliyoruz", ro: "Venim" },
  { tr: "Geliyorsunuz", ro: "Veniți" },
  { tr: "Geliyorlar", ro: "Vin" },
  { tr: "Kalmak", ro: "A rămâne" },
  { tr: "Kalıyorum", ro: "Rămân" },
  { tr: "Kalıyorsun", ro: "Rămâi" },
  { tr: "Kalıyor", ro: "Rămâne" },
  { tr: "Kalıyoruz", ro: "Rămânem" },
  { tr: "Kalıyorsunuz", ro: "Rămâneți" },
  { tr: "Kalıyorlar", ro: "Rămân" },
  { tr: "Aç olmak", ro: "A îi fi foame" },
  { tr: "Acıktım", ro: "Mi-e foame" },
  { tr: "Acıktın", ro: "Ți-e foame" },
  { tr: "Acıktı", ro: "Îi este foame" },
  { tr: "Acıktık", ro: "Ne este foame" },
  { tr: "Acıktınız", ro: "Vă este foame" },
  { tr: "Acıktılar", ro: "Le este foame" },
  { tr: "Beğenmek", ro: "A plăcea" },
  { tr: "Seviyorum", ro: "Îmi place" },
  { tr: "Seviyorsun", ro: "Îți place" },
  { tr: "Seviyor", ro: "Îi place" },
  { tr: "Seviyoruz", ro: "Ne place" },
  { tr: "Seviyorsunuz", ro: "Vă place" },
  { tr: "Seviyorlar", ro: "Le place" },
  { tr: "Acil", ro: "Urgent" },
